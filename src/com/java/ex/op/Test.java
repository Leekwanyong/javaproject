...
public class Test {
	...
	private void initialize() {
		...
		btnNewButton_5.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				// 占쏙옙 占쏙옙호화
					...
					order.setMovietitle(movetitleValue);
		...
		movietitle.setBounds(92, 252, 429, 44);
		...
		screeningplace.setBounds(92, 187, 429, 44);
		...
		btnMovieexpected.setIcon(new ImageIcon("./MovieImg/video_player.png"));
		...
		데시벨제목.setBounds(320, 309, 146, 15);
		...
		유포자들제목.setBounds(320, 549, 146, 15);
